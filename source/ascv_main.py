...
class AboutWindow(QtWidgets.QWidget):
    def __init__(self, Form, parent=None):
        ...
        self.label_3.setPixmap(QtGui.QPixmap(":/icon/globe"))
    ...
    #def updateImage(self):
    #    mwWidth = self.verticalLayout_4.geometry().width()
    #    mwHeight = self.verticalLayout_4.geometry().height()
    #
    #    pixmap_ = QtGui.QPixmap(":/icon/icon")
    #    pixmap = pixmap_.scaled(mwWidth, mwHeight, QtCore.Qt.KeepAspectRatio, QtCore.Qt.SmoothTransformation)
    #    self.image.setPixmap(pixmap)
    #    self.image.resize(mwWidth, mwHeight)
    #
    #def resizeEvent(self, event):
    #    self.updateImage()